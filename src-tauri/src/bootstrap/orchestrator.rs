...
mod tests {
    ...
    // ========================================================================
    // Live fixture tests — need Docker (`colima start`) + the `flightdeck-server`
    // repo checked out as a sibling. `cargo test --lib -- --ignored --nocapture`.
    //
    ...
    mod live {
        ...
        /// `flightdeck-server` repo's own Dockerfile). This is the exact "real
