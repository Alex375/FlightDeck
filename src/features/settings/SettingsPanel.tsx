          ...
          <div className={styles.content}>
            ...
            {!searching && section === "general" && (
              <div>
                ...
                {/* `PermissionPrefs` used to sit here; it now lives in the Behavior
                    tab (what Claude may do without asking). Rendering it in both
                    places would put the same switch in two tabs. */}
